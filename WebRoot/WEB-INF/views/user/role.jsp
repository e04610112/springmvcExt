...
role = {
	all : ctx + '/role/all.do',// 加载所有
	save : ctx + "/role/save",//保存
	del : ctx + "/role/del/",//删除
	allModules : ctx + "/module/allForTree.do",//系统菜单
	saveModules : ctx + "/module/saverole.do",//保存角色与系统菜单
	myModules : ctx + "/module/selectModulesByRoleId.do",
	childNodes : '',
	pageSize : 20
	// 每页显示的记录数
};
			...
			listeners : {
				'cellclick' : function(obj, rowIndex, columnIndex, e) {
					...
					if (record) {
						...
						// 当前选择用户的资源信息
						Share.AjaxRequest({
									url : role.myModules +"?roleId="+ record.data.roleId,
